...
namespace SocialSecurityNumber
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            socialSecurityNumber = ValidSocialSecurityNumber(socialSecurityNumber);
            ...
            var generation = CalculateGeneration(birthDate);
        ...
        private static string CalculateGeneration(DateTime birthDate)
        {
            string generation;
        ...
        private static string ValidSocialSecurityNumber(string socialSecurityNumber)
        {
